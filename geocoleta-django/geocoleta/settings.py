...
DATABASES = {
    'default': {
        ...
        'NAME': 'geocoleta',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(ROOTDIR, 'medias')
...
SECRET_KEY = '=--u8ws@-o6cxnp$(x_-18wt8qhr1jxtecgrqai*73cehwj8=v'
...
WSGI_APPLICATION = 'geocoleta.wsgi.application'
...
TEMPLATE_DIRS = (
	...
	os.path.join(ROOTDIR, "templates/admin"),
)
